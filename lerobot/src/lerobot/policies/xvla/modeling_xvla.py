...
from lerobot.policies.pretrained import ActionSelectKwargs, PreTrainedPolicy, T
...
class XVLAPolicy(PreTrainedPolicy):
    ...
    def _get_action_chunk(self, batch: dict[str, Tensor], **kwargs: Unpack[ActionSelectKwargs]) -> Tensor:
        inputs = self._build_model_inputs(batch)
